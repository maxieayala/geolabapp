...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			...
			<form method="GET" action="{{ route('proyectos') }}" class="d-sm-inline-block form-inline navbar-search w-50">
				<div class="py-2 flex">
					<div class="input-group mb-3">
						<input type="search" name="search" id="search" value="{{ request()->input('search') }}" class="form-control small" placeholder="Buscar por Cedula, Numero de Prestamo" aria-label="Search" aria-describedby="basic-addon2">
