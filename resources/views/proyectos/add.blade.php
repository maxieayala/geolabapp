                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <select class="form-control form-control-proyecto @error('status') is-invalid @enderror"
                                name="status" id="status" placeholder="Estado actual de proyecto"
                                value="{{ old('status') }}">
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <input type="text"
                                class="form-control form-control-proyecto @error('nombre') is-invalid @enderror"
                                placeholder="Nombre de proyecto" name="nombre" id="nombre" value="{{ old('nombre') }}">
                            @error('nombre')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <select class="form-control form-control-proyecto @error('cliente_id') is-invalid @enderror"
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <input type="text"
                                class="form-control form-control-proyecto @error('direccion') is-invalid @enderror"
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <input type="text"
                                class="form-control form-control-proyecto @error('ubicacion') is-invalid @enderror"
                                placeholder="Agregar una ubicacion" name="ubicacion" id="ubicacion"
                                value="{{ old('ubicacion') }}">
                            @error('ubicacion')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <input type="date"
                                class="form-control form-control-proyecto @error('Fecha_inicio') is-invalid @enderror"
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <input type="date"
                                class="form-control form-control-proyecto @error('Fecha_fin') is-invalid @enderror"
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <input type="text"
                                class="form-control form-control-proyecto @error('nombre_contacto') is-invalid @enderror"
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <input type="tel"
                                class="form-control form-control-proyecto @error('telefono_contacto') is-invalid @enderror"
                    ...
                    <div class="row">
                        <div class='panel large-6 columns'>
                            ...
                            <div class='panel-content has_many'>
                                ...
                                <div class='row'>
                                    <a href='#' class='add-has_many fa fa-plus' data-target-id='proyectos_items'
                                        id='add_proyectos'></a>
                                </div>
