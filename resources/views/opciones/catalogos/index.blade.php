        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div id="treeview">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <!-- aca inicia el frame izquierdo Mostrar -->

                            <h6 class="m-0 font-weight-bold text-primary">Catalogos</h6>
                            <!-- aca inicia tabla hover over -->
                                    ...
                                    @foreach ($Catalogos as $catalogo)
                                        ...
                                        <tr>
                                            ...
                                            <td style="display: flex">
                                                <!-- aca agrego los botones de editar/borrar -->
                                                ...
                                                <a href="{{ route('catalogo.destroy', $catalogo->id) }}"
                                            ...
                                            ">
                                                ...
                                                <form id="delete-form-{{ $catalogo->id }}"
                                                    action="{{ route('catalogo.destroy', $catalogo->id) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                    ...
                                    if (data.success) {
                                        ...
                                        if (children.length > 0) {
                                            ...
                                            $.each(children, function(index, child) {
                                                var li = $('<li>').attr('data-id', child.id)
                                                    .text(child.nombre);
