                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <select class="form-control form-control-user @error('guard_name') is-invalid @enderror"
                                ...
                                <option value="web"
                                    {{ old('guard_name') ? (old('guard_name') == 'web' ? 'selected' : '') : ($permission->guard_name == 'web' ? 'selected' : '') }}>
                                    Web</option>
                                <option value="api"
                                    {{ old('guard_name') ? (old('guard_name') == 'api' ? 'selected' : '') : ($permission->guard_name == 'api' ? 'selected' : '') }}>
                                    Api</option>
                            </select>
                            @error('guard_name')
                                <span class="text-danger">{{ $message }}</span>
